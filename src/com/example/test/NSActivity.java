...
public class NSActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_ns = (ListView) findViewById(R.id.lv_ns);
...
//				String list = path.gettList();
				String list = "/nvdr/";
				data = ImgParser.getInfo(NSActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(NSActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(NSActivity.this, MainActivity.class);
				...
				lv_ns.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_ns.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_ns.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(NSActivity.this,android.R.layout.simple_spinner_item, str){
