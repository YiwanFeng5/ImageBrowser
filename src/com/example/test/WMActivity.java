...
public class WMActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_wm = (ListView) findViewById(R.id.lv_wm);
...
//				String list = path.gettList();
				String list = "/tp/";
//				Log.d("<<<<<<<<<<<<", list);
				data = ImgParser.getInfo(WMActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(WMActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(WMActivity.this, MainActivity.class);
				...
				lv_wm.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_wm.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_wm.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(WMActivity.this,android.R.layout.simple_spinner_item, str){
