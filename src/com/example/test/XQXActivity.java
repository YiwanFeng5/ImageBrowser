...
public class XQXActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_xqx);
		
		lv_xqx = (ListView) findViewById(R.id.lv_xqx);
...
//				Log.d("<<<<<<<<<<<<", list);
				data = ImgParser.getInfo(XQXActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(XQXActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(XQXActivity.this, MainActivity.class);
				...
				lv_xqx.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_xqx.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_xqx.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(XQXActivity.this,android.R.layout.simple_spinner_item, str){
