...
//
//public class XGActivity extends Activity implements OnClickListener{
//
//	ListView lv_xg;
...
//		
//		lv_xg = (ListView) findViewById(R.id.lv_xg);
...
//				String list = "/zipai/";
//				data = ImgParser.getInfo(XGActivity.this,list);
//				return null;
//			}
//
//			@Override
...
//				adapter = new SimpleAdapter(XGActivity.this,data,R.layout.item,from,to){
//
//					@Override
...
//								Intent intent = new Intent(XGActivity.this, MainActivity.class);
...
//					Log.d("<<<<<<<<", "adapter为空！");
//				}
//				lv_xg.setAdapter(adapter);
//				adapter.notifyDataSetChanged();
//				lv_xg.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
//				lv_xg.setOnItemClickListener(new OnItemClickListener() {
//
//					@Override
...
//	                
//	                adapter1 = new ArrayAdapter<String>(XGActivity.this,android.R.layout.simple_spinner_item, str){
//
//						@Override
//						public View getView(int position, View convertView,
//								ViewGroup parent) {
