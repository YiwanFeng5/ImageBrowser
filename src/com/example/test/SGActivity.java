...
public class SGActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_sg = (ListView) findViewById(R.id.lv_sg);
...
//				String list = path.gettList();
				String list = "/shangan/";
				data = ImgParser.getInfo(SGActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(SGActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(SGActivity.this, MainActivity.class);
				...
				lv_sg.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_sg.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_sg.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(SGActivity.this,android.R.layout.simple_spinner_item, str){
