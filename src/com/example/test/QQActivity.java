...
public class QQActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_qq = (ListView) findViewById(R.id.lv_qq);
...
//				String list = path.gettList();
				String list = "/mk/";
				data = ImgParser.getInfo(QQActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(QQActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
				...
				lv_qq.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_qq.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_qq.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(QQActivity.this,android.R.layout.simple_spinner_item, str){
