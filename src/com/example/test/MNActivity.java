...
//
//public class MNActivity extends Activity implements OnClickListener{
//
//	ListView lv_mn;
...
//		
//		lv_mn = (ListView) findViewById(R.id.lv_mn);
...
//				String list = "/zipai/";
//				data = ImgParser.getInfo(MNActivity.this,list);
//				return null;
//			}
//
//			@Override
...
//				adapter = new SimpleAdapter(MNActivity.this,data,R.layout.item,from,to){
//
//					@Override
...
//								Intent intent = new Intent(MNActivity.this, MainActivity.class);
...
//					Log.d("<<<<<<<<", "adapter为空！");
//				}
//				lv_mn.setAdapter(adapter);
//				adapter.notifyDataSetChanged();
//				lv_mn.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
//				lv_mn.setOnItemClickListener(new OnItemClickListener() {
//
//					@Override
...
//	                
//	                adapter1 = new ArrayAdapter<String>(MNActivity.this,android.R.layout.simple_spinner_item, str){
//
//						@Override
//						public View getView(int position, View convertView,
//								ViewGroup parent) {
