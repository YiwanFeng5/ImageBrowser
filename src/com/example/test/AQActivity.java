...
public class AQActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_aq = (ListView) findViewById(R.id.lv_aq);
...
//				String list = path.gettList();
				String list = "/aiqing/";
				data = ImgParser.getInfo(AQActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(AQActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(AQActivity.this, MainActivity.class);
				...
				lv_aq.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_aq.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_aq.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(AQActivity.this,android.R.layout.simple_spinner_item, str){
