...
public class GXActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_gx = (ListView) findViewById(R.id.lv_gx);
...
//				String list = path.gettList();
				String list = "/gaoxiao/";
				data = ImgParser.getInfo(GXActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(GXActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(GXActivity.this, MainActivity.class);
				...
				lv_gx.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_gx.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_gx.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(GXActivity.this,android.R.layout.simple_spinner_item, str){
