...
public class FZLActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fzl);
		
		lv_fzl = (ListView) findViewById(R.id.lv_fzl);
...
//				String list = path.gettList();
				String list = "/fzl/";
//				Log.d("<<<<<<<<<<<<", list);
				data = ImgParser.getInfo(FZLActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(FZLActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(FZLActivity.this, MainActivity.class);
				...
				lv_fzl.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_fzl.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_fzl.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(FZLActivity.this,android.R.layout.simple_spinner_item, str){
