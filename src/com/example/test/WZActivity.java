...
public class WZActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_wz = (ListView) findViewById(R.id.lv_wz);
...
//				String list = path.gettList();
				String list = "/qmt/";
				data = ImgParser.getInfo(WZActivity.this,list);
				return null;
			}
			...
			protected void onPostExecute(Void result) {
				...
				adapter = new SimpleAdapter(WZActivity.this,data,R.layout.item,from,to){
...
//								Log.d("--MYTEST--", getItemId(p)+"");
								Intent intent = new Intent(WZActivity.this, MainActivity.class);
				...
				lv_wz.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				lv_wz.setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
				lv_wz.setOnItemClickListener(new OnItemClickListener() {
...
//				Log.d("--MYTEST--", list+"");
			...
			protected void onPostExecute(Void result) {
				 String[] str = string.split("##");
	                ...
	                adapter1 = new ArrayAdapter<String>(WZActivity.this,android.R.layout.simple_spinner_item, str){
